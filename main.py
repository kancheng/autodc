...
# Args
# EX: python3 yolo2masks.py --txt="./datasets/yolo/gluet/labels"  --img="./datasets/yolo/gluet/images" --out="./outputs/masks/gluet"
parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter)
parser.add_argument('--txt')
parser.add_argument('--img')
parser.add_argument('--out', default='./outputs/masks/dname')
...
for num in range(len(pimg_val_imgs)):
    ...
    txt_path_val = ptxt_val + ptxt_val_txts[num]
